...
function Withdrawal(id, emp_id, amount, date, type, delivered, camp_id, work_id, description) {
    this.id = id;
    this.emp_id = emp_id;
    this.amount = amount;
    this.type = type;
...
Withdrawal.prototype.show = function () {
    ...
    console.log(id + ", " + emp_id + ", " + amount + ", " + type + ", " + delivered + ", " + camp_id + ", " + work_id + ", " + date + ", " + description + ".");
}
...
Withdrawal.prototype.makePersistent = async function () {
    ...
    await pool.query("insert into jeg_adm.withdrawal values (default," + emp_id + ",'" + amount + "','" + date + "','" + type + "','" + delivered + "'," + camp_id + "," + work_id + ",'" + description + "');");
}
...
Withdrawal.prototype.pullData = async function () {
    ...
    const info = await pool.query("select employee_id, withdrawal_amount, withdrawal_type, withdrawal_date, withdrawal_description, delivered, work_id, campaign_id, work_id, to_char(withdrawal_date, 'YYYY-MM-DD') as withdrawal_date from jeg_adm.withdrawal where withdrawal_id=" + id + ";");
...
Withdrawal.prototype.updateData = async function () {
    ...
    await pool.query("update jeg_adm.withdrawal set employee_id=" + emp_id + ",delivered='" + delivered + "',withdrawal_amount=" + amount + ",withdrawal_type='" + type + "',withdrawal_description='" + description + "',campaign_id=" + camp_id + ",work_id=" + work_id + ",withdrawal_date='" + date + "' where withdrawal_id=" + id + ";");
}
